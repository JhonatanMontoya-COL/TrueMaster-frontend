<template>
  <LayoutMain>
      <template #slotLayout>
        ...
        <Formulario :titulo="'Gestion de Oficinas'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario">
            <template #slotForm>
                <el-row :gutter="20">
...
<script setup>
  ...
  import FormularioOficinas from "./components/formOficinas.vue"
