<template>
  <LayoutMain>
      <template #slotLayout>
        ...
        <Formulario :titulo="'Gestion de departamentos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario">
            <template #slotForm>
                <el-row :gutter="20">
...
<script setup>
  ...
  import FormularioDptos from "./components/formDptos.vue"
